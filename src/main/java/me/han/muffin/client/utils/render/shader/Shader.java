...
public abstract class Shader {
    ...
    public Shader(final String fragmentShader) {
        ...
        try {
            final InputStream vertexStream = getClass().getResourceAsStream("/assets/minecraft/shader/vertex.vert");
            ...
            final InputStream fragmentStream = getClass().getResourceAsStream("/assets/minecraft/shader/fragment/" + fragmentShader);
        ...
        ClientLoader.LOGGER.info("[Shader] Successfully loaded: " + fragmentShader);
    }
